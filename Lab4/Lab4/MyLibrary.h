...
public:
    ...
    ////lista intializare: obiectul pe care il vom folosi pentru afisare, numar de carti, vector de id-uri de carti --> aloca memorie pentur vector si copiaza numerele
